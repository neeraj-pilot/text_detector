...
class _TextOverlayWidgetState extends State<TextOverlayWidget>
  ...
  void _updateSelectedBlocks() {
    ...
    for (int i = 0; i < widget.textBlocks.length; i++) {
      final block = widget.textBlocks[i];
                ...
                decoration: BoxDecoration(
                  color: isSelected
                      ? CupertinoColors.activeBlue.withValues(
                          alpha: _isDragging ? _pulseAnimation.value : 0.25)
                      : widget.showUnselectedBoundaries
                          ? Colors.grey.withValues(alpha: 0.08)
                          : Colors.transparent,
                  border: widget.showUnselectedBoundaries || isSelected
                      ? Border.all(
                          color: isSelected
